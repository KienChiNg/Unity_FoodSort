...
public class BuildScript
{
	public static void BuildAPK()
	{
		...
		string keystorePath = "grill.keystore";
		string keystorePass = "pdp_ntn_2025"; // Password for the keystore	
		string keyAlias = "grill_sort"; // Alias for the key
		string keyPass = "pdp_ntn_2025"; // Password for the key
	...
	public static void BuildAAB()
	{
		...
		// TODO : Replace the values with your own keystore file and passwords
		string keystorePath = "grill.keystore";
		string keystorePass = "pdp_ntn_2025";
		string keyAlias = "grill_sort";
		string keyPass = "pdp_ntn_2025";
